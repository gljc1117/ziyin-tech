...
export default function EditorialArticleBody({ article }: { article: EditorialArticle | CompanyNewsArticle }) {
  return <div className="mt-6 text-slate-700">
    ...
    {article.id === "recursive-self-improvement-medical-ai-20260915" ? <RsiFramework /> : hasOpinionVisual(article.id) ? <OpinionFramework id={article.id} /> : <Figure item={article.cover} />}
